defmodule VialKeeper.View.BuilderRuntimeTest do
  ...
  alias VialKeeper.TestSupport.{AdmissionClassProbe, ViewBuilderProbe}
  ...
  setup do
    rel = "view-runtime-#{System.unique_integer([:positive])}.vialkeeper"
  ...
  test "history truncation abandons and restarts generation", %{uuid: uuid} do
    ...
    assert {:error, %VialKeeper.Error{code: :history_truncated}} =
             VialKeeper.Changes.read(uuid, %{since: 2, limit: 10}, admission_class: :maintenance)
