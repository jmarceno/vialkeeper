defmodule VialKeeper.View.BuilderTest do
  ...
  alias VialKeeper.TestSupport.{AdmissionScenario, ViewBuilderProbe}
  ...
  setup do
    rel = "view-builder-#{System.unique_integer([:positive])}.vialkeeper"
  ...
  test "startup resumes persisted views exactly once", %{uuid: uuid} do
    ...
    assert [{pid, _}] =
             Registry.lookup(VialKeeper.Runtime.DatabaseRegistry, {:view_builder, uuid, view_id})
