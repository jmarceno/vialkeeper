defmodule ElixirDB.Observability.Instrumentation.Shadow do
  @moduledoc "Observability emitters for shadow reads and exact-route fallback."

  alias ElixirDB.Observability.{Meters, Tracer}

  @read_span "elixir_db.shadow.read"
  @read_count :"elixir_db.shadow.read.count"
  @fallback_span "elixir_db.shadow.route.fallback"
  @fallback_count :"elixir_db.shadow.route.fallback.count"
