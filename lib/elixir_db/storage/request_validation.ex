defmodule ElixirDB.Storage.RequestValidation do
  @moduledoc """
  ...
  @spec validate_uuid(term()) :: :ok | {:error, ElixirDB.Error.t()}
  ...
  @spec validate_non_negative_integer(term(), binary()) :: :ok | {:error, ElixirDB.Error.t()}
  ...
  @spec validate_positive_integer(term(), binary()) :: :ok | {:error, ElixirDB.Error.t()}
  ...
  @spec validate_changes_limit(term(), term()) :: :ok | {:error, ElixirDB.Error.t()}
  ...
  @spec validate_changes_since_floor(integer(), map()) :: :ok | {:error, ElixirDB.Error.t()}
