defmodule ElixirDB.Storage.SQLite.Retention do
  ...
  alias ElixirDB.Storage.Services.Retention
  alias ElixirDB.Storage.SQLite.{Adapter, RetentionRecords}

  @doc "Clears pending local causal markers."
  @spec clear_pending_local_causal(term()) :: :ok | {:error, ElixirDB.Error.t()}
  ...
  @spec retention_state(map()) :: {:ok, map()} | {:error, ElixirDB.Error.t()}
  ...
  @spec list_peer_positions(term()) :: {:ok, list()} | {:error, ElixirDB.Error.t()}
  ...
  @spec read_boundary_pages(map(), map()) :: {:ok, map()} | {:error, ElixirDB.Error.t()}
  ...
  @spec install_boundary_pages(map(), map()) :: {:ok, map()} | {:error, ElixirDB.Error.t()}
