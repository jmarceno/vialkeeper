defmodule ElixirDB.DerivedView.Engine do
  @moduledoc """
  ...
  @spec validate_history_epoch(map(), binary()) :: :ok | {:error, ElixirDB.Error.t()}
  ...
  @spec validate_rebuild_source(map(), integer()) :: :ok | {:error, ElixirDB.Error.t()}
  ...
  @spec validate_materialization(map(), map()) :: :ok | {:error, ElixirDB.Error.t()}
    ...
    case numeric do
      ...
      _ ->
        ...
        with {:ok, min_float} <- numeric_value(min_value),
          ...
          false ->
            {:error, ElixirDB.Error.integrity_violation("derived numeric sort is inconsistent")}
  ...
  @spec reducer_output(atom(), map()) :: {:ok, term()} | {:error, ElixirDB.Error.t()}
  ...
  @spec decode_definition(binary()) :: {:ok, map()} | {:error, ElixirDB.Error.t()}
  ...
  @spec load_context(map(), map(), (map() -> {:ok, map()} | {:error, ElixirDB.Error.t()})) ::
          {:ok, map()} | {:error, ElixirDB.Error.t()}
  ...
  @spec required_string(map(), atom()) :: {:ok, binary()} | {:error, ElixirDB.Error.t()}
  ...
  defp required_list(map, key) do
    case MapAccess.get(map, key) do
      ...
      _ -> {:error, ElixirDB.Error.invalid_request("#{key} must be an array")}
    end
  end
