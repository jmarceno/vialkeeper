defmodule ElixirDB.Replication.BlobRepresentationStream do
  @moduledoc """
  ...
  @encoding_header "x-elixirdb-blob-encoding"
  @logical_length_header "x-elixirdb-blob-logical-length"
  @payload_sha256_header "x-elixirdb-blob-payload-sha256"
