defmodule ElixirDB.View.Engine do
  @moduledoc """
  ...
  @spec validate_query_fields(map()) :: :ok | {:error, ElixirDB.Error.t()}
  ...
  @spec query_view_id(map()) :: {:ok, binary()} | {:error, ElixirDB.Error.t()}
  ...
  @spec normalize_query_limit(map(), map()) :: {:ok, pos_integer()} | {:error, ElixirDB.Error.t()}
  ...
  defp clamp_query_limit(value, maximum) when is_integer(value) and value > maximum,
    do: {:error, ElixirDB.Error.resource_limit("view query limit exceeds the configured maximum")}

  defp clamp_query_limit(_value, _maximum),
    do: {:error, ElixirDB.Error.invalid_request("view query limit must be a positive integer")}

  @doc "Validates query options such as consistency, key bounds, and bookmarks."
  @spec validate_query_options(map()) :: :ok | {:error, ElixirDB.Error.t()}
  ...
  @spec build_query_plan(map(), map(), map()) ::
          {:ok, query_plan()} | {:error, ElixirDB.Error.t()}
  ...
  @spec validate_batch_cas(map(), integer(), integer()) ::
          {:ok, :apply | :idempotent} | {:error, ElixirDB.Error.t()}
  ...
  @spec ensure_building_generation(map(), integer()) :: :ok | {:error, ElixirDB.Error.t()}
  ...
  @spec ensure_no_conflict(map() | nil, map()) :: :ok | {:error, ElixirDB.Error.t()}
  ...
  @spec view_fault_check(term(), atom()) :: :ok | {:error, ElixirDB.Error.t()}
