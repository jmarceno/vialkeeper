defmodule ElixirDB.Query.Executor do
  @moduledoc """
  ...
  alias ElixirDB.Query.{FullText, Ordering, Plan, Predicate, Projection, Selector}
  ...
  @spec check_deadline(deadline()) :: :ok | {:error, ElixirDB.Error.t()}
  ...
  @spec validate_bookmark_plan(map(), Plan.t()) :: :ok | {:error, ElixirDB.Error.t()}
  ...
  @spec plan_error(map(), ElixirDB.Error.t()) :: {:error, ElixirDB.Error.t()}
  ...
  @spec filter_query([document()], map(), Plan.t(), deadline()) ::
          {:ok, [document()]} | {:error, ElixirDB.Error.t()}
