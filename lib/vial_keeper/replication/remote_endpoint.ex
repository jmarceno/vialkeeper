defmodule VialKeeper.Replication.RemoteEndpoint do
  ...
  def diff_blobs(endpoint, digests) when is_list(digests) do
    case call(
      ...
      {:ok, _} ->
        {:error,
         VialKeeper.Error.database_unavailable("remote endpoint returned an invalid blob diff")}
  ...
  defp changes_request(%VialKeeper.Changes.Request{since: since, limit: limit, wait_ms: wait_ms}),
