defmodule VialKeeper.Query.Subscription.Events do
  ...
  @type error_event :: %{type: :error, error: VialKeeper.Error.t()}
  ...
  @spec error(VialKeeper.Error.t()) :: error_event()
  def error(%VialKeeper.Error{} = error), do: %{type: :error, error: error}
  ...
  def public(%{type: :error, error: error}),
    do: %{"type" => "error", "error" => VialKeeper.Error.public(error)}
