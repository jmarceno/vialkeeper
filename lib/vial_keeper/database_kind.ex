defmodule VialKeeper.DatabaseKind do
  ...
  def normalize(_),
    do:
      {:error,
       VialKeeper.Error.invalid_request("database kind must be ordinary, derived, or shadow")}
  ...
  @spec from_storage(term()) :: {:ok, t()} | {:error, VialKeeper.Error.t()}
