defmodule VialKeeper.HTTP.Routes.QueryStream do
  ...
  alias VialKeeper.Observability.Instrumentation.Subscription, as: SubscriptionTelemetry
  ...
  defp maybe_record_overload(uuid, %{
         type: :error,
         error: %VialKeeper.Error{code: :subscription_overloaded}
       }) do
