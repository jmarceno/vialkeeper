defmodule VialKeeper.Observability.Attributes do
  @moduledoc """
  ...
  @allowed [
    ...
    blocking_peer_count: :blocking_peer_count,
    bootstrap_required_count: :bootstrap_required_count,
    old_floor: :old_floor,
    new_floor: :new_floor,
    old_compaction_epoch: :old_compaction_epoch,
    new_compaction_epoch: :new_compaction_epoch,
    floor_changed: :floor_changed,
    compaction_epoch_changed: :compaction_epoch_changed,
