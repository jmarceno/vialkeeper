defmodule VialKeeper.Observability.Instrumentation.DerivedView do
  @moduledoc "Bounded tracing and metrics for materialized-view batches."

  alias VialKeeper.Error
  alias VialKeeper.Observability.{Meters, Tracer}

  @span "vial_keeper.derived_view.batch"
  @duration_metric :"vial_keeper.derived_view.batch.duration"
  @max_count 10_000
