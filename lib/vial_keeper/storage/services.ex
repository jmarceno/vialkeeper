defmodule VialKeeper.Storage.Services do
  @moduledoc """
  ...
  @spec close(BackendContext.t()) :: :ok | {:error, VialKeeper.Error.t()}
  ...
  @spec list_indexes(BackendContext.t()) :: {:ok, list()} | {:error, VialKeeper.Error.t()}
  ...
  @spec delete_index(BackendContext.t(), binary()) :: :ok | {:error, VialKeeper.Error.t()}
  ...
  @spec shadow_origin(BackendContext.t(), binary()) ::
          {:ok, non_neg_integer() | nil} | {:error, VialKeeper.Error.t()}
  ...
  @spec retention_state(BackendContext.t()) :: {:ok, map()} | {:error, VialKeeper.Error.t()}
  ...
  @spec list_peer_positions(BackendContext.t()) :: {:ok, list()} | {:error, VialKeeper.Error.t()}
  ...
  @spec integrity_check(BackendContext.t(), map()) :: {:ok, map()} | {:error, VialKeeper.Error.t()}
  ...
  @spec list_views(BackendContext.t()) :: {:ok, [map()]} | {:error, VialKeeper.Error.t()}
  ...
  @spec create_view(BackendContext.t(), map()) :: {:ok, map()} | {:error, VialKeeper.Error.t()}
  ...
  @spec delete_view(BackendContext.t(), binary()) :: {:ok, map()} | {:error, VialKeeper.Error.t()}
  ...
  @spec view_state(BackendContext.t(), binary()) :: {:ok, map()} | {:error, VialKeeper.Error.t()}
  ...
  @spec apply_view_batch(BackendContext.t(), map()) :: {:ok, map()} | {:error, VialKeeper.Error.t()}
  ...
  @spec query_view(BackendContext.t(), map()) :: {:ok, map()} | {:error, VialKeeper.Error.t()}
  ...
  @spec get_derived_view(BackendContext.t()) :: {:ok, map()} | {:error, VialKeeper.Error.t()}
  ...
  @spec list_derived_sources(BackendContext.t()) :: {:ok, [map()]} | {:error, VialKeeper.Error.t()}
  ...
  defp require_document(nil),
    do: {:error, VialKeeper.Error.document_not_found("document does not exist")}
  ...
  defp revision_batch_result(%{
    ...
    cond do
      is_nil(document) ->
        {:error,
         VialKeeper.Error.integrity_violation("changes entry references a missing document", %{
           document_id: document_id,
           revision_id: revision_id
         })}
      ...
      is_nil(revision) ->
        {:error,
         VialKeeper.Error.integrity_violation("changes entry references a missing revision", %{
           document_id: document_id,
           revision_id: revision_id
         })}
  ...
  defp call_optional_port(%BackendContext{} = context, family, fun)
    ...
    if Access.available?(context, family) do
      ...
      {:error,
       VialKeeper.Error.invalid_request("storage backend does not implement the #{family} port")}
    end
  end
