defmodule VialKeeper.Storage.Services.DerivedViews do
  @moduledoc """
  ...
  alias VialKeeper.Storage.Services.{Facts, Mutations}
  alias VialKeeper.Storage.Transaction

  @doc "Loads derived view metadata and definition."
  @spec get(BackendContext.t()) :: {:ok, map()} | {:error, VialKeeper.Error.t()}
  ...
  @spec set_enabled(BackendContext.t(), map()) :: {:ok, map()} | {:error, VialKeeper.Error.t()}
  ...
  def set_enabled(_context, _request),
    do: {:error, VialKeeper.Error.invalid_request("derived enable request must be an object")}

  @doc "Lists derived source checkpoints."
  @spec list_sources(BackendContext.t()) :: {:ok, [map()]} | {:error, VialKeeper.Error.t()}
  ...
  def set_source_error(_context, _request),
    do: {:error, VialKeeper.Error.invalid_request("derived source error must be an object")}
  ...
  def apply_source_batch(_context, _request),
    do: {:error, VialKeeper.Error.invalid_request("derived source batch must be an object")}
  ...
  def begin_source_rebuild(_context, _request),
    do: {:error, VialKeeper.Error.invalid_request("derived rebuild request must be an object")}
  ...
  def apply_rebuild_page(_context, _request),
    do: {:error, VialKeeper.Error.invalid_request("derived rebuild page must be an object")}
  ...
  def prune_rebuild_stale_page(_context, _request),
    do: {:error, VialKeeper.Error.invalid_request("derived stale-prune page must be an object")}
  ...
  def finish_source_rebuild(_context, _request),
    do: {:error, VialKeeper.Error.invalid_request("derived rebuild finish must be an object")}
  ...
  defp decode_group_key(json) when is_binary(json) do
    case StrictDecoder.decode(json) do
      ...
      _ -> {:error, VialKeeper.Error.integrity_violation("derived group key is invalid")}
    end
  end
