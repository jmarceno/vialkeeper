defmodule VialKeeper.Storage.Services.Import do
  @moduledoc """
  ...
  alias VialKeeper.Storage.Services.Shadows
  ...
  defp body_size_within_limit?(body) do
    case Canonical.encode(body) do
      {:ok, json} ->
        byte_size(json) <= (VialKeeper.Config.host_limits()[:max_document_bytes] || 1_048_576)
