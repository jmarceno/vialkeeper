defmodule VialKeeper.Storage.Services.Facts do
  @moduledoc """
  ...
  @spec find_revision(BackendContext.t(), binary(), binary()) ::
          {:ok, Revision.t() | nil} | {:error, VialKeeper.Error.t()}
  ...
  @spec empty_document(BackendContext.t(), binary()) :: :ok | {:error, VialKeeper.Error.t()}
  ...
  @spec append_change(BackendContext.t(), change_entry()) :: :ok | {:error, VialKeeper.Error.t()}
  ...
  @spec append_changes(BackendContext.t(), [change_entry()]) :: :ok | {:error, VialKeeper.Error.t()}
  ...
  @spec mark_pending_local_causal(BackendContext.t()) :: :ok | {:error, VialKeeper.Error.t()}
  ...
  @spec ready_definitions(BackendContext.t()) :: {:ok, [term()]} | {:error, VialKeeper.Error.t()}
