defmodule VialKeeper.Storage.Services.Views do
  ...
  alias VialKeeper.View.{Definition, Engine}

  @doc "Lists view catalog entries."
  @spec list(BackendContext.t()) :: {:ok, [map()]} | {:error, VialKeeper.Error.t()}
  def list(%BackendContext{} = context), do: port(context).list_views(context)

  @doc "Creates a view definition."
  @spec create(BackendContext.t(), map()) :: {:ok, map()} | {:error, VialKeeper.Error.t()}
  ...
  @spec delete(BackendContext.t(), binary()) :: {:ok, map()} | {:error, VialKeeper.Error.t()}
  ...
  @spec state(BackendContext.t(), binary()) :: {:ok, map()} | {:error, VialKeeper.Error.t()}
  ...
  @spec apply_batch(BackendContext.t(), map()) :: {:ok, map()} | {:error, VialKeeper.Error.t()}
  ...
  @spec begin_rebuild(BackendContext.t(), map()) :: {:ok, map()} | {:error, VialKeeper.Error.t()}
  ...
  @spec finish_rebuild(BackendContext.t(), map()) :: {:ok, map()} | {:error, VialKeeper.Error.t()}
  ...
  @spec query(BackendContext.t(), map()) :: {:ok, map()} | {:error, VialKeeper.Error.t()}
  ...
  def query(_context, _request),
    do: {:error, VialKeeper.Error.invalid_request("view query must be an object")}
  ...
  defp enforce_definition_limit(count, config) do
    ...
    if count < maximum,
      do: :ok,
      else: {:error, VialKeeper.Error.resource_limit("view definition limit exceeded")}
  end
