defmodule VialKeeper.Storage.SQLite.ViewStatePort do
  @moduledoc """
  SQLite view-state fact port.

  Routes opaque contexts to physical `VialKeeper.Storage.SQLite.Views` operations
  ...
  alias VialKeeper.Storage.SQLite.{Adapter, Context, Views}
