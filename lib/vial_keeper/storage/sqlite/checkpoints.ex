defmodule VialKeeper.Storage.SQLite.Checkpoints do
  ...
  defp validate_no_regression(current, incoming) do
    if regresses?(current, incoming),
      do:
        {:error,
         VialKeeper.Error.checkpoint_conflict("checkpoint regressed safe or compaction epoch", %{
           previous_safe:
