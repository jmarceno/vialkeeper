defmodule VialKeeper.Storage.SQLite.DerivedStatePort do
  @moduledoc """
  SQLite derived-state fact port.

  Routes opaque contexts to physical `VialKeeper.Storage.SQLite.DerivedViews`
  ...
  alias VialKeeper.Storage.SQLite.{Context, DerivedViews}
