...
| ARCH-001, ARCH-002, ARCH-003, ARCH-004, ARCH-005, ARCH-006, ARCH-007, ARCH-008, ARCH-009 | Runtime.DatabaseRuntimeSupervisor, DatabaseOwner, DatabaseAdmission, Storage.Adapter | test/runtime/replication_test.exs, test/storage_adapter/v1_conformance_test.exs (via ElixirDB.Storage.AdapterCase) |
...
| JSON-001, JSON-002, JSON-003, JSON-004, JSON-005, JSON-006 | JSON.StrictDecoder, JSON.Canonical, document validation | test/contract/fixtures_test.exs (priv/fixtures/canonical_json), test/contract/json_and_revision_test.exs, test/contract/v1_contracts_test.exs, test/storage_adapter/v1_conformance_test.exs |
...
| REV-001, REV-002, REV-003, REV-004, REV-005, REV-006, REV-007, REV-008, REV-009, REV-010 | Revisions.Id, Winner, ConflictResolution, SQLite revision persistence | test/contract/fixtures_test.exs (priv/fixtures/revision_ids), test/contract/json_and_revision_test.exs, test/storage_adapter/v1_conformance_test.exs |
...
| QUERY-014, QUERY-015, QUERY-016, QUERY-017, QUERY-018 | Query.FullText, FTS5 index manager and integrity checks | test/contract/fixtures_test.exs (priv/fixtures/tokenization), test/storage_adapter/v1_conformance_test.exs |
...
| REPL-014, REPL-015, REPL-016, REPL-017, REPL-018 | replication request validation, handshake, complete chains, import transaction, worker registry/cancellation | test/contract/fixtures_test.exs (priv/fixtures/protocol/replication_wire), test/contract/v1_contracts_test.exs, test/storage_adapter/v1_conformance_test.exs, test/runtime/replication_test.exs |
...
| API-001, API-002, API-003, API-004, API-005, API-006, API-007, API-008, API-009 | HTTP.Request, BodyReader, Response, protocol version and envelopes | test/contract/fixtures_test.exs (priv/fixtures/protocol/http_envelopes), test/http/router_test.exs, test/http/v1_http_contract_test.exs |
